<?php require_once __DIR__ . '/../components/head.php'; ?> <?php require_once __DIR__ . '/../components/header.php'; ?> <main class="px-1.5">
  <div class="container mt-20 mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md">
      ...
      <div class="p-6 border-b border-gray-200 flex justify-between items-center">
        ...
        <!-- Edit Button -->
        <div class="pt-2">
              <button @click="openModal" id="editProfileBtn" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"> Edit Profile </button>
        </div>
      </div>
      <!-- Profile Content -->
      <div class="p-6">
        <div class="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
          ...
          <div class="flex flex-col items-center space-y-3">
            <div class="w-32 h-32 rounded-full overflow-hidden bg-gray-100">
              <img src="/api/placeholder/128/128" alt="" class="w-full h-full object-cover" />
            </div>
          ...
          <div class="flex-1 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p class="text-gray-800 font-medium"><?=$user['account_number']?></p>
              </div>
              <div>
              ...
              <div>
                ...
                <p class="text-gray-800 font-medium"><?=$user['account_type']?></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 transform translate-y-1/2" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform translate-y-1/2" @click.away="closeModal" @keydown.escape="closeModal" class="w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl" role="dialog" id="modal">
      ...
      <div class="mt-4 mb-6">
        ...
        <form class="mt-4" action="/user/profile" method="POST">
          ...
          <div class="mb-4">
            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-400"> old Password </label>
          ...
          <div class="mb-4">
            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-400"> Profile picture </label>
            <input type="file" id="profile" name="profile" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white py-2 px-3">
          </div>
