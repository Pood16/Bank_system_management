...
<?php require_once __DIR__ . '/../components/header.php'; ?> 
    <main class="h-full overflow-y-auto">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="picture" id="picture" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
            </div>
