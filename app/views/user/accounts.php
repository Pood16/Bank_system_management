    ...
    <div class="mt-6 bg-white rounded-lg shadow">
        <div class="p-6">
            ...
            <div class="mt-6 grid grid-cols-1 gap-4">
                <button @click="isModal3Open = true" class="w-fullflex items-center justify-center p-3 text-purple-600 border border-purple-600 rounded-lg hover:bg-purple-50">
